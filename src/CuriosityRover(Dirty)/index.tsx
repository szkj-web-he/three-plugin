...
import msl_clean_mtl from './Assets/MSL_dirty.mtl';
import msl_clean_obj from './Assets/MSL_dirty.obj';
...
import tex_03_s from './Assets/tex_03_s.png';
import { animation } from '../CuriosityRover(Clean)/Unit/animation';
    ...
    useEffect(() => {
        ...
        void (async () => {
            ...
            const tex_array = Promise.all([
                ...
                new TextureLoader().loadAsync(tex_03_s),
            ...
            const tex_03_update = (p: MeshPhongMaterial) => {
                ...
                p.specularMap = tex_03_s_i;
            };
            mtl.updateMaterial('tex_03', tex_03_update);
            mtl.updateMaterial('tex_03a', tex_03_update);
            mtl.updateMaterial('wheels', tex_03_update);
